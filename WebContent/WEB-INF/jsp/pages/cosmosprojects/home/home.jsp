			...
			<td width="100%">
				<div width="100%">
					<div style="overflow:auto;">
						...
						<br/><br/>
						More information on Cosmos is available <a target="cosmos" href="https://confluence.nachc.org/display/COS/Cosmos">here</a>.  
						<br/><br/>
						More information on our Informatics team is available <a target="informatics" href="https://confluence.nachc.org/display/INFO/Welcome+to+NACHC+Informatics">here</a>.
						<br/><br/>
						More information on NACHC is available <a target="nachc" href="https://www.nachc.org/">here</a>.  
					</div>
				</div>
			</td>
		</tr>
